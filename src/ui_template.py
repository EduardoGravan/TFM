...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # TODO: Añadir conexion de otros botones
    ...
    def search_twitter(self):
            dialog = self.__loading_menu()
            query = self.textEdit.toPlainText()
            self.populate_table(query, dialog)

    def __loading_menu(self):
        dialog = QtWidgets.QDialog(self.centralwidget)
        dialog.setWindowTitle("Cargando tweets. . .")
        dialog.resize(250, 1)
        dialog.open()

        return dialog

    def populate_table(self, query, loading_dialog):
            self.tableWidget.setRowCount(0)
